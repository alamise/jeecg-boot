package org.jeecg.modules.demo.robot.vo;
 ...
 */
@Data
@ApiModel(value="rb_lifecircle_push_configPage对象", description="圈子推送设置")
public class RbLifecirclePushConfigPage {
	...
	@ExcelCollection(name="圈子推送配置明细")
	@ApiModelProperty(value = "圈子推送配置明细")
	private List<RbLifecirclePushConfigDetail> rbLifecirclePushConfigDetailList;
